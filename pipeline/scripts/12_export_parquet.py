...
TABLES = [
    ...
    ('main', 'stress_scenarios'),
    ('main', 'stress_scenarios_domestic'),
    ('main', 'stress_scenarios_international'),
    ('main', 'fdic_sdi_features'),
    ('main', 'clean_bank_panel'),
    ('main', 'cdr_unrealized_losses'),
    ('main', 'entity_xref'),
    # C3 new sources (2026-06): NCUA credit unions (scope expansion) + SEC EDGAR CIK crosswalk
    ('main', 'ncua_5300'),
    ('main', 'ncua_cu_directory'),
    ('main', 'sec_cik_crosswalk'),
    ('main', 'hmda_summary'),
    ('main', 'id_crosswalk'),
    ('main', 'nic_entity_identifiers'),
    ('main', 'nic_attributes_ext'),
    ('main', 'ubpr_ratios'),
    ('main', 'ubpr_peer_stats'),
    ('main', 'ubpr_peer_rank'),
    ('main', 'y15_systemic_indicators'),
    ('catalog', 'variables'),
    ('catalog', 'namespace_variables'),
...
SORT_KEYS = {
    ...
    'clean_bank_panel': 'era_group, src_vintage, bank_id, rssd_id, year, call_date',
    'cdr_unrealized_losses': 'rssd_id, period_end',
    'entity_xref': 'rssd_id',
    'ncua_5300': 'cu_number, schedule, account_code',
    'ncua_cu_directory': 'cu_number',
    'sec_cik_crosswalk': 'cik',
    'hmda_summary': 'activity_year, lei, loan_purpose',
    'id_crosswalk': 'rssd_id',
    'nic_entity_identifiers': 'rssd_id',
    'nic_attributes_ext': 'rssd_id',
    'ubpr_ratios': 'period_end, rssd_id, ubpr_code',
    'y15_systemic_indicators': 'period_end, rssd_id, risk_code',
}
