...
MAIN_TABLES = [
    ...
    "fdic_history",
    "fred_series",
    "robin_panel_base",  # W4 footgun guard: robin_panel was renamed to robin_panel_base;
                         # the public 'robin_panel' is now a guarded VIEW (see VIEWS below).
...
VIEWS = [
    ...
    # W4 footgun guards (scripts/48): robin_panel is now a guarded view; occ split views.
    "robin_panel", "occ_1867_1904", "occ_clv_1863_1941",
]
...
PARQUET_FILES = [
    ...
    "fred_series.parquet",
    # W4 footgun guard: robin_panel is now a guarded VIEW (not exported); the base
    # table robin_panel_base is what gets the parquet. robin_panel.parquet removed.
    "robin_panel_base.parquet",
